...
import com.ishmail_projects_jwt_string_angular.book_network.file.FileStorageService;
import com.ishmail_projects_jwt_string_angular.book_network.history.BookTransactionHistory;
import com.ishmail_projects_jwt_string_angular.book_network.history.BookTransactionHistoryRepository;
...
import static com.ishmail_projects_jwt_string_angular.book_network.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public PageResponse<BookResponse> findAllBooks(int page, int size, Authentication connectedUser) {
        ...
        Page<Book> books = bookRepository.findAllDisplayablePages(pageable, user.getId());
